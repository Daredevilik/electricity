...
function SearchForm({handleClose }) {
    ...
    const until = useSelector((state) => state.date.from);
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
                ...
                <Form.Control type="datetime-local" placeholder="Date from" name="from" defaultValue={convertToInputFormat(from)}/>
            </Form.Group>
            <Form.Group className="mb-3">
                <Form.Label>Until</Form.Label>
                <Form.Control type="datetime-local" placeholder="Date until" name="until" defaultValue={convertToInputFormat(until)}/>
            </Form.Group>
